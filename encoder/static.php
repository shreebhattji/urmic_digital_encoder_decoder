            ...
            switch ($input_source) {
                case "hdmi":
                    $input .= "ffmpeg -hwaccel auto -hide_banner -f v4l2 -thread_queue_size 512 -input_format mjpeg "
                        ...
                        . " -fflags +genpts -use_wallclock_as_timestamps 1 -f alsa -thread_queue_size 512 -i " . $data['hdmi']['audio_source']
            ...
            switch ($input_source) {
                case "hdmi":
                    $input .= "ffmpeg -hwaccel auto -hide_banner -f v4l2 -thread_queue_size 512 -input_format mjpeg -video_size " . $data['hdmi']['resolution']
                        . " -framerate " . $data['hdmi']['framerate'] . " -i /dev/video0 -fflags +genpts -use_wallclock_as_timestamps 1 -f alsa -thread_queue_size 512 -i " . $data['hdmi']['audio_source']
                        . " -c:v h264_qsv ";
                    if ($hdmi_delay_video != "")
